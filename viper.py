...
#
# Check the length of p1
#
# Parameters:
#   (queue_list): A set of x and y coordinates(p1's location)
#   (max_length): The max legal length of a player
#
# Returns:
#   True if p1 exceeds the max legal length, False otherwise.
#   A new list which has already removed the oldest point
#
...
# Check whether a line intersects with any lines in the group
#
# Parameters:
#   (prv): A set of x and y coordinates. It refers to the group of lines.
#   (new): A list with 4 values. It refers to the line to be compared with.
#
# Returns:
#   True if any lines in the group intersect with the line in list 'new', False otherwise.
#
...
def getAICount(background):
  ...
  setFont("Arial", 15)
  setColor("black")
  text(getWidth() / 2, 350, "How many players?")
  ...
  num_players = 0
  while not closed() and num_players == 0:
